...
export default function Section05Marketing() {
  ...
  return (
    <section className="snap-section bg-[#1a2535] relative flex flex-col py-0 px-0">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto h-[20vh] flex flex-col justify-end px-[5%] pb-4 shrink-0">
        ...
        <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
          <h2 className="font-impact text-white text-4xl md:text-5xl leading-tight text-white">Estratégia de marketing</h2>
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto h-[35vh] flex gap-10 px-[5%] items-center justify-center shrink-0">
         ...
         >
           <div className="bg-[#111] text-white p-3 flex items-center justify-between shrink-0">
              <span className="font-montserrat text-[13px] font-bold uppercase tracking-wider flex items-center gap-2"><Mail size={14}/> Caixa de Entrada</span>
              <span className="font-lato text-[12px] text-gray-400">AGORA</span>
           </div>
           <div className="p-4 bg-gray-50 border-b border-gray-100 shrink-0">
              <h4 className="font-montserrat font-bold text-[15px] text-[#333]">IA para PMEs — Semana 42</h4>
              <p className="font-lato text-[13px] text-gray-500">newsletter@crescitech.com</p>
           </div>
         ...
         >
            <div className="p-3 bg-white flex items-center gap-3 shrink-0">
               <div className="w-8 h-8 rounded-full bg-[#1D3557] flex justify-center items-center font-bold text-[#00B5C5] text-[13px] font-montserrat uppercase">CR</div>
               <span className="font-montserrat font-bold text-[14px] text-black w-full flex justify-between items-center">
            ...
            <div className="w-full flex-1 bg-[#1D3557] relative flex flex-col items-center justify-center px-6 text-center overflow-hidden">
               ...
               <div className="absolute top-3 right-3 text-[11px] font-montserrat uppercase font-bold bg-[#F5A800] text-black px-2 py-0.5 rounded shadow">PMEs</div>
               <div className="absolute bottom-3 text-[11px] text-white/50 tracking-wider font-montserrat">ARRASTE PARA O LADO</div>
            </div>
      ...
      {/* Bot (45vh) - Carrossel de Iframes Instgrm (Container modificado para height auto e 620px min ht slide) */}
      <div className="relative z-10 w-full pt-[2vh] flex-1 flex flex-col overflow-visible pb-4">
         <div className="w-full max-w-[1400px] mx-auto px-[5%] flex items-center justify-between mb-3 shrink-0">
           <span className="text-white/60 text-[13px] font-montserrat font-bold uppercase tracking-[0.2em] pl-3 border-l-[3px] border-[#00B5C5]">Feed Instagram Orgânico</span>
         ...
         <div 
           ref={scrollRef}
           className="w-full h-auto overflow-x-auto overflow-y-visible flex gap-6 px-[5%] custom-scrollbar pb-[20px] pl-[5%] snap-x snap-mandatory pt-2 items-start"
         ...
         >
            ...
            <div className="w-[10%] shrink-0 min-h-[620px]"></div>
         </div>
      </div>
    </section>
  );
